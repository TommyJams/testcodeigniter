		...
		?>
			<form action="" name="dibReaction" id="dibReaction" method="post">        
				...
				<div style="width:45%; float:left; padding-top:10px; padding-right:5px; height:33px;">
					<input type="submit" value="Accept" name="accept" id="accept" style="width: 48%; background:#B4F62F; float:left;" onClick="showDibReaction('<?print("$linker");?>', '<?print("$artist_id");?>', 1)">
