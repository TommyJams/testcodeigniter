...
class Artist extends CI_Controller{
	...
	public function artistpage(){
		...
		if(!isset($this->session->userdata('username_artist')))
		{
		...
		$username=$this->session->userdata('username_artist');
		$password=md5($this->session->userdata('password_artist'));
		...
		$this->load-view('artist_view', $_SESSION);
	}
}
?>
